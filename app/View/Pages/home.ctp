             ...
             <ul id="revolutionul" style="display:none;">
                 ...
                 <li data-transition="fade" data-slotamount="8" data-masterspeed="700" data-delay="9400" data-thumb="">
                     <div class="caption lfl slide_item_left"
                          ...
                          <?php echo $this->Html->image("banner/ban2.png" ); ?>
                     </div>
                 ...
                 <li data-transition="fade" data-slotamount="8" data-masterspeed="700" data-delay="9400" data-thumb="">
                     ...
                     <?php echo $this->Html->image("banner/banner_bg.jpg" ); ?>
                     ...
                     <div class="caption lft start"
                          ...
                          data-start="2000"
                          data-easing="easeOutBack"  >
                         <?php echo $this->Html->image("banner/man.png" ); ?>
                     ...
                     <div class="caption lft slide_item_right"
                          ...
                          data-start="5000"
                          data-easing="easeOutBack">
                          <?php echo $this->Html->image("banner/test_man.png",  array('id' => 'rev-hint2')); ?>
                     </div>
                 ...
                 <li data-transition="fade" data-slotamount="7" data-masterspeed="300" data-delay="9400" data-thumb="">
                    <?php echo $this->Html->image("banner/red-bg.jpg" ); ?>
                     <div class="caption lfl slide_item_right"
                          ...
                          data-start="1500"
                          data-easing="easeOutBack">
                          <?php echo $this->Html->image("banner/imac.png" ); ?>
                     </div>
                     <div class="caption lfl slide_item_right"
                          data-x="25"
                          data-y="345"
                          ...
                          data-start="2000"
                          data-easing="easeOutBack">
                          <?php echo $this->Html->image("banner/tab.png" ); ?>
                     </div>
                     <div class="caption lfl slide_item_right"
                          data-x="200"
                          data-y="330"
                          ...
                          data-start="2500"
                          data-easing="easeOutBack">
                          <?php echo $this->Html->image("banner/mobile.png" ); ?>
                     </div>
                     <div class="caption lfl slide_item_right"
                          data-x="250"
                          data-y="230"
                          ...
                          data-start="3000"
                          data-easing="easeOutBack">
                          <?php echo $this->Html->image("banner/laptop.png" ); ?>
                     </div>
                     <div class="caption lfl slide_item_right"
                          data-x="165"
                          data-y="30"
                          ...
                          data-start="5000"
                          data-easing="easeOutBack">
                          <?php echo $this->Html->image("banner/text_imac.png",  array('id' => 'rev-hint1')); ?>
                     </div>
     ...
     <section class="parallax1">
         <div class="container">
             <div class="row">
                 <h1>"A vingança nunca é plena, mas tem sabor de mel."</h1>
             </div>
         </div>
     </section>
     <!--parallax end-->
