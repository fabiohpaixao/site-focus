                     ...
                     <div class="about-skill-meter">
                         <div class="progress progress-xs">
                             <div style="width: 60%;" aria-valuemax="100" aria-valuemin="0" aria-valuenow="60" role="progressbar" class="progress-bar progress-bar-danger">
                                 <span class="sr-only">Comp 1 : 60% Complete</span>
                             </div>
                         </div>
                     </div>
                     <div class="about-skill-meter">
                         <div class="progress progress-xs">
                             <div style="width: 90%;" aria-valuemax="100" aria-valuemin="0" aria-valuenow="60" role="progressbar" class="progress-bar progress-bar-danger">
                                 <span class="sr-only">Comp 2 : 90% Complete</span>
                             </div>
                         </div>
                     </div>
                     <div class="about-skill-meter">
                         <div class="progress progress-xs">
                             <div style="width: 70%;" aria-valuemax="100" aria-valuemin="0" aria-valuenow="60" role="progressbar" class="progress-bar progress-bar-danger">
                                 <span class="sr-only">Comp 3 : 70% Complete</span>
                             </div>
                         </div>
                     </div>
                     <div class="about-skill-meter">
                         <div class="progress progress-xs">
                             <div style="width: 55%;" aria-valuemax="100" aria-valuemin="0" aria-valuenow="60" role="progressbar" class="progress-bar progress-bar-danger">
                                 <span class="sr-only">Comp 4 : 55% Complete</span>
                             </div>
                         </div>
                     </div>
                 </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                <div class="person text-center">
                    <?php echo $this->Html->image("team/team_img1.jpg" ); ?>
                </div>
                <div class="person-info text-center">
                    <h4>
                        <a href="javascript:;">Thiago Silva</a>
                    </h4>
            ...
            <div class="col-lg-4">
                <div class="person text-center">
                    <?php echo $this->Html->image("team/team_img2.jpg" ); ?>
                </div>
                <div class="person-info text-center">
                    <h4>
                        <a href="javascript:;">Alexandra Silva</a>
                    </h4>
                    <p class="text-muted">Chefa </p>
                    <div class="team-social-link">
                        <a href="#"><i class="icon-facebook"></i></a>
                        <a href="#"><i class="icon-twitter"></i></a>
                        <a href="#"><i class="icon-pinterest"></i></a>
            ...
            <div class="col-lg-4">
                <div class="person text-center">
                    <?php echo $this->Html->image("team/team_img3.jpg" ); ?>
                </div>
                <div class="person-info text-center">
                    <h4>
                        <a href="javascript:;">Panetone</a>
                    </h4>
                    <p class="text-muted">Estagiário </p>
                    <div class="team-social-link">
                        <a href="#"><i class="icon-facebook"></i></a>
                        <a href="#"><i class="icon-twitter"></i></a>
                        <a href="#"><i class="icon-pinterest"></i></a>
